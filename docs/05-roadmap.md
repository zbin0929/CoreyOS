...
| 9     | Workflow Engine       | Visual DAG editor + multi-agent orchestration + template marketplace | ~3 weeks  | **Planned** (2026-04-25). Product direction pivot: desktop-native workflow automation for non-technical users. References: Dify, CrewAI, Mastra, LangGraph, Google ADK. See `docs/phases/phase-9-workflow.md`. |
