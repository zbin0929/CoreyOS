...
| 5     | Multi-agent console   | 2+ non-Hermes adapters running side-by-side            | ~1 week   | **In progress** — T5.1 shipped (2026-04-23): adapter trait polish (`Health.last_error`/`uptime_ms`, `ChatTurn.cwd`, session search/limit). Next: T5.2 Claude Code adapter. |
