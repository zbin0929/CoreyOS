...
| 5     | Multi-agent console   | 2+ non-Hermes adapters running side-by-side            | ~1 week   | **In progress** — T5.1 + T5.2a + T5.5a + T5.5b shipped (2026-04-23). T5.1: trait polish. T5.2a: Claude Code **mock** + conformance suite. T5.5a: read-only AgentSwitcher. T5.5b: active selection (localStorage-persisted) + capability-gated Sidebar + chat routes via `adapter_id`. Deferred: T5.5c unified inbox, T5.2b real CLI, T5.3 Aider. |
