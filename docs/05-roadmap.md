...
| 5     | Multi-agent console   | 2+ non-Hermes adapters running side-by-side            | ~1 week   | **Next** — unblocked by 2026-04-23 close-out (T1.5c/d/e + T4.4b + T4.6b + P2 profile revert); remaining phase-1-4 deferrals triaged in `docs/06-backlog.md` |
