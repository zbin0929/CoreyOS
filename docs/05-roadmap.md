...
| 8     | Multimodal            | Voice push-to-talk via cloud APIs | 2–3 weeks | **Shipped** (2026-04-26). 4 providers (OpenAI/Zhipu/Groq/Edge TTS), system-level mic recording (cpal), push-to-talk in chat, TTS playback on messages, audit log, Settings UI. 7 IPC commands. |
...
Total ~11–12 weeks solo from Phase 0 through Phase 12. Post-Phase-12 focus shifted to Pack architecture (v0.2.0) and industry Pack development (v0.3.0).
...
| v0.1.13 | 2026-05-01 | Skills tree fix + macOS icon fix + E2E fix + doc sync |
| v0.1.14 | 2026-05-01 | Windows CMD popup fix + icon grey-edge second fix |
| v0.1.15 | 2026-05-01 | Windows real-device pass + suppress_window full coverage + icon edge pure black |
