...
| 5     | Multi-agent console   | 2+ non-Hermes adapters running side-by-side            | ~1 week   | **In progress** — T5.1 + T5.2a + T5.3a + T5.5a + T5.5b shipped (2026-04-23). Trait polish + Claude Code **mock** + Aider **mock** + conformance suite + AgentSwitcher (read-only → active selection, capability-gated Sidebar, `adapter_id` chat routing). Three adapters online. Deferred: T5.5c unified inbox, T5.2b/T5.3b real CLIs. |
