...
| 2     | Config & Ops          | Models, Analytics, Logs, Settings, Profiles            | ~1 week   | **Shipped** (2026-04-22) — T2.1–T2.8 all green; profile tar.gz import/export landed 2026-04-23; per-profile gateway control still deferred (see `docs/phases/phase-2-config.md`) |
