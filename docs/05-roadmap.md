...
| 3     | Platform channels     | 8 channels + gateway restart + WeChat QR               | ~1 week   | **In progress** — T3.1 channel catalog + read-only grid shipped (2026-04-22); T3.2–T3.5 pending. See `docs/phases/phase-3-channels.md`. |
