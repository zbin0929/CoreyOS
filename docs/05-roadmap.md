...
| 1     | Chat core             | Real SSE chat, sessions, tool calls, attachments       | 3–4 days  | **Sprint 1 shipped** (2026-04-21) — streaming chat + markdown rendering live; sessions/tools/attachments in Sprint 2 |
