...
| 5     | Multi-agent console   | 2+ non-Hermes adapters running side-by-side            | ~1 week   | **In progress** — T5.1 + T5.2a shipped (2026-04-23). T5.1: adapter trait polish (`Health.last_error`/`uptime_ms`, `ChatTurn.cwd`, session search/limit). T5.2a: Claude Code **mock** adapter + shared conformance suite; registered alongside Hermes. Next: T5.2b real CLI wiring or T5.5 AgentSwitcher. |
