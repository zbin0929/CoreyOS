...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ipc::security::guard_prompt_resolve,
            ...
            ipc::hermes_memory::memory_fact_search,
            ipc::hermes_memory::memory_entity_list,
            ipc::hermes_memory::memory_entity_facts,
            ipc::hermes_memory::corey_relation_add,
            ipc::hermes_memory::corey_graph_query,
            ...
            ipc::hermes_config::hermes_update_check,
            ...
            ipc::pack::pack_exchange_rate_config_get,
            ...
            ipc::browser_cdp::browser_cdp_status,
