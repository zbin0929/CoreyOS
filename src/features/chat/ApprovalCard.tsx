...
export function ApprovalCard({ approval, sessionId, onResolved }: Props) {
  ...
  return (
    <div className="my-2 rounded-xl border border-amber-500/25 bg-gradient-to-br from-amber-500/8 to-orange-500/5 p-4 space-y-3 shadow-lg shadow-amber-500/5">
      ...
      <div className="ml-6 rounded-lg bg-black/25 border border-white/5 px-3 py-2">
        <code className="block text-xs text-amber-200/90 font-mono whitespace-pre-wrap break-all leading-relaxed">
          {approval.command}
        </code>
      </div>
      ...
      <div className="flex gap-2 justify-end pt-1">
        <button
          ...
          disabled={!!loading}
          className={`${btnBase} bg-red-500/15 text-red-400 hover:bg-red-500/25`}
        >
        ...
        <button
          ...
          disabled={!!loading}
          className={`${btnBase} bg-emerald-500/15 text-emerald-400 hover:bg-emerald-500/25`}
        >
        ...
        <button
          ...
          disabled={!!loading}
          className={`${btnBase} bg-sky-500/15 text-sky-400 hover:bg-sky-500/25`}
        >
        ...
        <button
          ...
          disabled={!!loading}
          className={`${btnBase} bg-violet-500/15 text-violet-400 hover:bg-violet-500/25`}
        >
